...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"alertNotify.js":[function(require,module,exports) {
"use strict";
...
var _alertNotify = require("./alertNotify");
...
function () {
  ...
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(pass, email) {
    var res;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.Status === "Success") {
            (0, _alertNotify.showAlert)("success", "login Successfully");
            console.log("hellow");
        ...
        case 7:
          ...
          (0, _alertNotify.showAlert)("error", _context.t0.response.data.message);
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(quatity, productId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          ...
          if (res.data.Status === "Success") {
            (0, _alertNotify.showAlert)("success", "Succefully added to cart");
          }
...
},{"axios":"../../node_modules/axios/index.js","./alertNotify":"alertNotify.js"}],"changeSetings.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === "password" ? "http://127.0.0.1:3000/api/v1/user/updateMyPassword" : "http://127.0.0.1:3000/api/v1/user/updateMe";
          _context.next = 4;
          return (0, _axios.default)({
            method: "PATCH",
            url: url,
        ...
        case 4:
          ...
          if (res.data.Status === "Success") {
            (0, _alertNotify.showAlert)("success", "Successfully changed Settings");
            window.setTimeout(function () {
  ...
  return function changeSettings(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.changeSettings = changeSettings;
},{"axios":"../../node_modules/axios/index.js","./alertNotify":"alertNotify.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _changeSetings = require("./changeSetings");

var loginForm = document.querySelector(".login-form");
var userPanel = document.querySelector(".user-vis");
...
var infoSettings = document.querySelector(".user-settingsss");
var userSettings = document.querySelector(".user-settings");
var addCart = document.querySelector(".add-to-cart");
var cartss = document.querySelectorAll(".cart-border");
var productCart = document.querySelector(".product-main");
...
if (userSettings) {
  userSettings.addEventListener("submit", function (e) {
    e.preventDefault();
    var currentPassword = document.querySelector(".current-pass").value;
    var NewPassword = document.querySelector(".new-pass").value;
    var passwordconfirm = document.querySelector(".confirm-pass").value;
    (0, _changeSetings.changeSettings)({
...
if (infoSettings) {
  infoSettings.addEventListener("submit", function (e) {
    e.preventDefault();
...
if (addCart) {
  addCart.addEventListener("submit", function (e) {
    ...
    (0, _addToCart.addToCart)(quantity, productId);
  });
} // cartss.forEach((el) => {
...
var eventControler = document.querySelectorAll(".plus-minus");
cartss.forEach(function (el) {
  var minusBtn = document.querySelector(".minus");
  var cardsQuantity = document.querySelector(".cart-quantity");
  minusBtn.addEventListener("click", function () {
    console.log("ADDED");
  });
});
},{"./login":"login.js","./addToCart":"addToCart.js","./changeSetings":"changeSetings.js"}],"../../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
